			...
			<div class="col-xl-10">
                  ...
                  <div class="card card-table-border-none">
                    <div class="card-header justify-content-between ">
                      <h2>Blocked Baby Sitters List</h2>
                    ...
                    <div class="card-body pt-0" data-simplebar style="height: 468px;">
                      <table class="table ">
                        <tbody>
						<tr><th>Service_Id</th><th>Service</th><th>Action</th></tr>
						<?php
...
?>
						  ...
						  <td ><?php echo $row['service_id'];?></td>
                            ...
                            <td class="text-dark d-none d-md-block"><?php echo $row['service'];?></td>
							<td >
							<a href="edit.php?id=<?php echo $row['service_id'];?>" id="approve">Edit</a>
							<a href="delete.php?id=<?php echo $row['service_id'];?>" id="reject">Delete</a>
							</td>
                          </tr>
                         <?php
			  }
