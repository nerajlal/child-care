      ...
      <!-- Github Link -->
		...
		<div class="row">
			<div class="col-xl-10">
              ...
              $result = mysql_query("SELECT * FROM tbl_sitterreg where s_sts='2'");
...
?>
						  ...
						  <td ><?php echo $row['sitter_id'];?></td>
                            <td >
                              <div class="media">
                                <div class="media-image mr-3 rounded-circle">
                                  <a href=""><img class="rounded-circle w-45" src="../../<?php echo $row['profile_pic'];?>" alt="customer image"></a>
                                </div>
							...
							<td >
							<a href="more1.php?id=<?php echo $row['mailid'];?>">Read More</a>
							</td>
                          </tr>
                         <?php
			  }
