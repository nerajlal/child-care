			...
			<div class="col-xl-10">
                  ...
                  <div class="card card-table-border-none">
                    ...
                    <div class="card-body pt-0" data-simplebar style="height: 468px;">
                      <table class="table ">
                        <tbody>
						<tr><th>Id</th><th>Gurdian Name</th><th>Baby Name</th><th>Action</th></tr>
						<?php

              include 'dbconnect.php';
              //$p=1;
			  //$uname=$_SESSION['username']; 
               $result = mysql_query("SELECT * FROM tbl_registration,tbl_login where 
        tbl_registration.g_mailid=tbl_login.username and tbl_login.sts='1'");
...
?>
              ...
              <td ><?php echo $row['baby_name'];?></td>
							<td > <a href="details1.php?id=<?php echo $row['baby_id'];?>">Read More</a> </td>
                          </tr>
                         <?php
			  }
?> 
