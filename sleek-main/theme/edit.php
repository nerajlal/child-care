       ...
       <form action="" method="POST">
		<div class="card card-default">
           ...
           <?php
              ...
              $result = mysql_query("SELECT * FROM tbl_services where service_id='$uname'");
			...
			<div class="col-sm-12">
				<label class="text-dark font-weight-medium" for="">Enter Service</label>
				<div class="input-group mb-2">

					<textarea class="form-control" id="service" name="service" value="<?php echo $row['service'];?>" 
					> </textarea>
				</div>
			</div>
...
<?php
							 ...
							 if(isset($_POST['submit']))
							 {
								 ...
								 $sql="update tbl_services set service='$_POST[service]' where service_id='$uname'";
								 //echo"$sql";
								 $result=mysql_query($sql,$con);
								if($result)
								{
									echo "<script>alert('Service updated!');location.href='eservices.php';</script>";
								}
							 	else
								{
									echo "<script>alert('not updated!');location.href='eservices.php';</script>";
								}
							 }	
