                      ...
                      <div class="card card-mini mb-4">
                        <div class="card-body">
                          <h2 class="mb-1">
                              ...
                              $link = mysqli_connect("localhost", "root", "", "babysitter");
                              $count=mysqli_num_rows(mysqli_query($link,"SELECT * FROM tbl_registration"));
                              echo $count;
                              ?>
                          </h2>
                      ...
                      <div class="card card-mini mb-4">
                        <div class="card-body">
                          <h2 class="mb-1">
                              ...
                              //include'dbconnect.php';
                             // $link = mysqli_connect("localhost", "root", "", "babysitter");
                              $count=mysqli_num_rows(mysqli_query($link,"SELECT * FROM tbl_sitterreg"));
                              echo $count;
                              ?>
                          </h2>
                          <p>Baby Sitters</p>
                      ...
                      <div class="card card-mini mb-4">
                        <div class="card-body">
                          <h2 class="mb-1">
                              ...
                              //include'dbconnect.php';
                              //$link = mysqli_connect("localhost", "root", "", "babysitter");
                              $count=mysqli_num_rows(mysqli_query($link,"SELECT * FROM tbl_services"));
                              echo $count;
                              ?>
                          </h2>
                          <p>Services</p>
