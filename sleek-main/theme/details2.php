...
<?php
        ...
        //$uname=$_SESSION['username']; 
              $result = mysql_query("SELECT * FROM tbl_registration,tbl_login where tbl_registration.g_mailid=tbl_login.username='$uname'");
...
<table id="customers">
  ...
  <tr><td>Name :</td><td><?php echo $row['g_name'];?></td></tr>
  <tr><td>Guardian Phno :</td><td><?php echo $row['g_phno'];?></td></tr>
  <tr><td>Alternate Phno :</td><td><?php echo $row['g_aphno'];?></td></tr>
  <tr><td>Mailid :</td><td><?php echo $row['g_mailid'];?></td></tr>
  <tr><td>Baby Name :</td><td><?php echo $row['baby_name'];?></td></tr>
  <tr><td>DOB :</td><td><?php echo $row['b_dob'];?></td></tr>
  <tr><td>Baby Gender :</td><td><?php echo $row['b_gender'];?></td></tr>
  <tr><td>House Name :</td><td><?php echo $row['h_name'];?></td></tr>
  <tr><td>Student Name :</td><td><?php echo $row['s_name'];?></td></tr>
  ...
  <tr><td>Country :</td><td><?php echo $row['country'];?></td></tr>
    <tr>
  <td><a href="approve.php?id=<?php echo $row['g_mailid'];?>" id="approve">Approve</a></td></tr>
