	...
	<div class="col-lg-6">
       ...
       <form action="" method="POST">
		<div class="card card-default">
			...
			<button  class="my-1 btn btn-sm btn-success" name="submit" type="submit">Add</button>
...
<?php
							 ...
							 {
								 $id=autoid("tbl_services","service_id");
								
								  


								 $sql="INSERT INTO `tbl_services` VALUES ('$id','$_POST[service]','0')";
								 //echo"$sql";
								 $result=mysql_query($sql,$con);
								if($result)
								{
									echo "<script>alert('Service Added!');location.href='eservices.php';</script>";
								}
							 	else
								{
									echo "<script>alert('not Added!');location.href='aservice.php';</script>";
								}
							 }	
