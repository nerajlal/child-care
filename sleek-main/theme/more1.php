...
<table id="customers">
	<tr><td>
			<div class="card">
			  <img src="../../<?php echo $row['profile_pic'];?>" alt="Avatar" style="width:50%"> 
	...
	<tr><td>ID Proof:</td><td><a href="../../<?php echo $row['id_proof'];?>"><img src="../../<?php echo $row['id_proof'];?>" alt="Avatar" style="width:50%"></a></td></tr>
	...
	<td><a href="unblock.php?id=<?php echo $row['mailid'];?>" id="reject">Unblock</a></td></tr>
