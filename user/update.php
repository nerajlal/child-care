    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
              ...
              $result = mysql_query("SELECT * FROM table_login where username='$uname'");
...
?>
							 ...
							 if(isset($_POST['submit']))
							 {
								 ...
								 $sql="update table_login set username='$_POST[username]',password='$_POST[password]' where username='$uname'";
								 //echo"$sql";
